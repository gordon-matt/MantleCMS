...
public class MantleDotNetDefaultDependoContainer : DotNetDefaultDependoContainer
{
    /// <inheritdoc />
    public override IServiceProvider ConfigureServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        {
            startupConfig.ConfigureServices(new DotNetDefaultContainerBuilder(services), configuration);
        }
