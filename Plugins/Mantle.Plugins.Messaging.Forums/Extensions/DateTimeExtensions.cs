...
public static class DateTimeExtensions
{
    extension(DateTime source)
    {
        ...
        public string RelativeFormat() => RelativeFormat(source, string.Empty);
        ...
        /// <returns>Formatted date and time string</returns>
        public string RelativeFormat(string defaultFormat) => RelativeFormat(source, false, defaultFormat);
        ...
        /// <param name="defaultFormat">Default format string (in case relative formatting is not applied)</param>
        /// <returns>Formatted date and time string</returns>
        public string RelativeFormat(bool convertToUserTime, string defaultFormat)
        {
