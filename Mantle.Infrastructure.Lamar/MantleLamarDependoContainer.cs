...
public class MantleLamarDependoContainer : LamarDependoContainer
{
    /// <inheritdoc />
    public override IServiceProvider ConfigureServices(ServiceRegistry serviceRegistry, IConfiguration configuration)
    {
        ...
        {
            startupConfig.ConfigureServices(new LamarContainerBuilder(serviceRegistry), configuration);
        }

        _container = (Container)RegisterDependencies(serviceRegistry, typeFinder, configuration);
