...
public class MantleAutofacDependoContainer : AutofacDependoContainer
{
    /// <inheritdoc />
    public override IServiceProvider ConfigureServices(ContainerBuilder containerBuilder, IConfiguration configuration)
    {
        ...
        {
            startupConfig.ConfigureServices(new AutofacContainerBuilder(containerBuilder), configuration);
        }
