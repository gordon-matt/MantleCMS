...
public abstract class IdentityMembershipService : IMembershipService
{
    ...
    private static readonly Dictionary<string, List<MantleRole>> cachedUserRoles;
    private static readonly Dictionary<string, List<MantlePermission>> cachedRolePermissions;
    ...
    {
        int id = Convert.ToInt32(permission.Id);
