...
tinymce.PluginManager.add('filemanager', function (editor) {
    ...
    function filemanager(id, value, type, win) {
        ...
        var rootFolder = "";
        if (document.getElementById("TinyMCE_RootFolder")) {
            rootFolder = "&rootFolder=" + document.getElementById("TinyMCE_RootFolder").value;
        }
        ...
        tinymce.activeEditor.windowManager.open({
            title: title,
            file: editor.settings.external_filemanager_path + 'dialog.php?type=' + urltype + '&descending=' + descending + sort_by + rootFolder + fldr + crossdomain + '&lang=' + editor.settings.language + '&akey=' + akey,
            width: width,
            height: height,
            resizable: true,
            maximizable: true,
