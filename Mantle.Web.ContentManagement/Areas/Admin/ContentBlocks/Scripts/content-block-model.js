export class ContentBlockViewModel {
    apiUrl = "/odata/mantle/cms/ContentBlockApi";
    ...
    init() {
        ...
        let readUrl = this.apiUrl;
        if (this.parent.pageId && this.parent.pageId != '') {
            readUrl += `/Default.GetByPageId(pageId=${this.parent.pageId})`;
        }
