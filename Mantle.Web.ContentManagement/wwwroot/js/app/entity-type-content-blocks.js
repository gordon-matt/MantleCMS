...
define(function (require) {
    ...
    class BlockModel {
        constructor(parent) {
            ...
            this.entityType = ko.observable(this.parent.entityType);
            this.entityId = ko.observable(this.parent.entityId);
        ...
        init = () => {
            ...
            GridHelper.initKendoGrid(
                "Grid",
                `/odata/mantle/cms/EntityTypeContentBlockApi?$filter=EntityType eq '${this.parent.entityType}' and EntityId eq '${this.parent.entityId}'`,
                {
                    fields: {
                        Title: { type: "string" },
        ...
        edit = async (id, cultureCode) => {
            ...
            await fetch(`/admin/blocks/entity-type-content-blocks/get-editor-ui/${this.id()}`)
        ...
        save = async () => {
            ...
            if (isNew) {
                ...
                if (this.cultureCode() != null) {
                    ...
                    await ODataHelper.putOData(`/odata/mantle/cms/EntityTypeContentBlockApi(${this.id()})`, record);
                }
            }
        };
