        ...
        public IDictionary<string, string> LocalizedStrings
        {
            get
            {
                return new Dictionary<string, string>
                {
                    ...
                    { MantleCmsLocalizableStrings.Messaging.GetTokensError, "Could not get tokens." },
                    { MantleCmsLocalizableStrings.Messaging.MessageTemplateModel.Body, "Body" },
                    { MantleCmsLocalizableStrings.Messaging.MessageTemplateModel.Enabled, "Enabled" },
                    { MantleCmsLocalizableStrings.Messaging.MessageTemplateModel.Name, "Name" },
                    { MantleCmsLocalizableStrings.Messaging.MessageTemplateModel.Subject, "Subject" },
                    { MantleCmsLocalizableStrings.Messaging.MessageTemplateModel.Tokens, "Tokens" },
                    { MantleCmsLocalizableStrings.Messaging.MessageTemplates, "Message Templates" },
                    { MantleCmsLocalizableStrings.Messaging.QueuedEmailModel.CreatedOnUtc, "Created On (UTC)" },
                    { MantleCmsLocalizableStrings.Messaging.QueuedEmailModel.SentOnUtc, "Sent On (UTC)" },
                    { MantleCmsLocalizableStrings.Messaging.QueuedEmailModel.SentTries, "Sent Tries" },
                    { MantleCmsLocalizableStrings.Messaging.QueuedEmailModel.Subject, "Subject" },
                    { MantleCmsLocalizableStrings.Messaging.QueuedEmailModel.ToAddress, "To Address" },
                    { MantleCmsLocalizableStrings.Messaging.QueuedEmails, "Queued Emails" },
                    { MantleCmsLocalizableStrings.Messaging.Title, "Messaging" },
