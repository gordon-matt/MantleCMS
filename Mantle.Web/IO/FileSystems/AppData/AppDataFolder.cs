...
//using Mantle.Web.IO.FileSystems.VirtualPath;
...
//            catch (Exception x)
//            {
//                throw new MantleException(string.Format("Unable to make room for file \"{0}\" in \"App_Data\" folder", destinationFileName), x);
//            }
//        }
