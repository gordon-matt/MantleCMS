...
public class MantleDependoLightInjectServiceProviderFactory : DependoLightInjectServiceProviderFactory
{
    /// <inheritdoc />
    public override IServiceProvider CreateServiceProvider(ServiceContainer container)
    {
...
#pragma warning disable DF0010 // Should not be disposed here.
        var dependoContainer = new MantleLightInjectDependoContainer();
#pragma warning restore DF0010
