...
namespace Mantle.Infrastructure.LightInject;

public class MantleLightInjectDependoContainer : LightInjectDependoContainer
{
    /// <inheritdoc />
    public override IServiceProvider ConfigureServices(ServiceContainer container, IConfiguration configuration)
    {
        ...
        {
            startupConfig.ConfigureServices(new LightInjectContainerBuilder(container), configuration);
        }
